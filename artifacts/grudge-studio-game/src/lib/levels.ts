...
function makeRuinsLevel(): LevelDef {
  ...
  return {
    ...
    skyColor: '#7a96a8', fogColor: '#9ab8cc', fogNear: 150, fogFar: 800,
...
function makeOrcLevel(): LevelDef {
  ...
  return {
    ...
    gridW: G, gridH: G, tileSize: TS,
    skyColor: '#5a1800', fogColor: '#7a2a08', fogNear: 80, fogFar: 450,
...
function makeElvenLevel(): LevelDef {
  ...
  return {
    ...
    gridW: G, gridH: G, tileSize: TS,
    skyColor: '#5590c8', fogColor: '#80b0d0', fogNear: 200, fogFar: 1000,
    obstacleTiles: obs, visionBlockers: vis, props,
...
function makeMedievalLevel(): LevelDef {
  ...
  return {
    ...
    gridW: G, gridH: G, tileSize: TS,
    skyColor: '#6090c0', fogColor: '#90b8d8', fogNear: 200, fogFar: 1100,
    obstacleTiles: obs, visionBlockers: vis, props,
