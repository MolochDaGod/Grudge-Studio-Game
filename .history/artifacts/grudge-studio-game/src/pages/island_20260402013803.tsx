  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-white flex flex-col items-center py-6 px-4 gap-6">
      ...
      <div className="flex items-center gap-4 w-full max-w-3xl">
        <Link href="/">
          <button className="text-white/60 hover:text-white text-sm border border-white/20 px-3 py-1 rounded">← Back</button>
        </Link>
      ...
      <div className="flex gap-3 items-center w-full max-w-3xl">
        ...
        <button onClick={() => { const s = Math.random().toString(36).slice(2, 10); setSeed(s); generate(s); }}
